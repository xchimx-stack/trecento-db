...
const checks=[
 ...
 ['single-click node press isolation',html.includes("g.addEventListener('pointerdown',stopNodePress)")&&html.includes("g.addEventListener('mousedown',(ev)=>{ev.stopPropagation()")],
 ...
 ['Dutch sparse-only outlier recovery',html.includes('const sparseNodes=nodes.filter')&&html.includes('sparseRecovery:ns.length<=1')],
 ...
 ['methodology current',html.includes('Methodology version 0.20.10')],
...
console.log('PASS: v0.20.10 current regression');
